"""Assistant utility functions for thread context management and message formatting.

Provides helper functions for retrieving conversation history, formatting context
...
def get_conversation_history(
    ...
    Raises:
        SlackApiError: If thread retrieval fails
    """
    try:
